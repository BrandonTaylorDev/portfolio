...
>
	...
	<div class="mx-auto flex max-w-5xl flex-row items-center justify-center">
		<div
		...
		>
			<div class="space-y-4 lg:text-start">
				...
				<div class="flex flex-col gap-4 sm:flex-row">
					...
					<a
						href="/projects"
						class="animate-fade-in-left animation-delay-400 inline-flex transform items-center gap-3 rounded-full border border-zinc-700 bg-zinc-800 px-8 py-4 text-lg font-medium text-zinc-100 shadow-lg transition-all duration-300 hover:scale-105 hover:border-zinc-600 hover:bg-zinc-700 hover:shadow-xl"
					>
						<svg class="h-7 w-7" viewBox="0 0 24 24">
							<path
								fill="currentColor"
