...
<section class="relative overflow-hidden w-full mt-64 py-32">
  ...
  <div class="max-w-5xl mx-auto px-6 py-12">
    <h2 bind:this={titleRef} class="text-3xl font-bold text-center mb-12 text-teal-400 opacity-0">
        ...
        >
          <div class="absolute -top-6 left-1/2 transform -translate-x-1/2">
            <div class="hexagon bg-teal-600 flex items-center justify-center">
              <svg class="text-white w-6 h-6" viewBox="0 0 24 24">
          ...
          <div class="mt-4">
            <h3 class="text-xl font-semibold text-teal-400 text-center mb-4">
              {card.title}
            </h3>
