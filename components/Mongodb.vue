...
<template>
  <aside
    :class="[
      ...
      props.modelValue ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'
    ]"
    @click.self="close"
  >
    <div class="w-full max-w-3xl max-h-dvh mx-auto overflow-y-auto bg-gray-50 dark:bg-gray-800 shadow rounded-xl">
